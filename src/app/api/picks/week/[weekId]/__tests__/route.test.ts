...
describe('/api/picks/week/[weekId] GET', () => {
  ...
  it('should return user picks for a week', async () => {
    ...
    const request = new NextRequest('http://localhost/api/picks/week/1', {
      method: 'GET',
      headers: {
    ...
    const response = await GET(request, { params: { weekId: '1' } });
  ...
  it('should return picks summary when summary=true', async () => {
    ...
    const request = new NextRequest('http://localhost/api/picks/week/1?summary=true', {
      method: 'GET',
      headers: {
        'authorization': 'Bearer token123',
        'x-user-id': 'user123',
  ...
  it('should return 400 when week ID is invalid', async () => {
    const request = new NextRequest('http://localhost/api/picks/week/invalid', {
      method: 'GET',
      headers: {
        'authorization': 'Bearer token123',
        'x-user-id': 'user123',
    ...
    const response = await GET(request, { params: { weekId: 'invalid' } });
    const data = await response.json();
  ...
  it('should parse week ID correctly for different values', async () => {
    ...
    for (const testCase of testCases) {
      const request = new NextRequest(`http://localhost/api/picks/week/${testCase.weekId}`, {
        method: 'GET',
        headers: {
          'authorization': 'Bearer token123',
          'x-user-id': 'user123',
      ...
      await GET(request, { params: { weekId: testCase.weekId } });
  ...
  it('should handle zero week ID', async () => {
    const request = new NextRequest('http://localhost/api/picks/week/0', {
      method: 'GET',
      headers: {
        'authorization': 'Bearer token123',
        'x-user-id': 'user123',
    ...
    const response = await GET(request, { params: { weekId: '0' } });
    const data = await response.json();
